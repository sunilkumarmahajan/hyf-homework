  ...
  function getWeather()
  {
    ...
    .then((data) => 
    {
        ...
        } else 
        {
          ...
          sunrise.textContent = `Sun Rise : ${new Date(data.sys.sunrise * 1000).toLocaleTimeString()}`;
          sunset.textContent = `Sun Set : ${new Date(data.sys.sunset * 1000).toLocaleTimeString()}`;
         }
      })
  }
